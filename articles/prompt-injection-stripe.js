/**
 * Checkout for Prompt Injection article.
...
(function () {
  ...
  var CANCEL_URL = 'https://www.securebydezign.com/articles/prompt-injection.html';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var buttons = document.querySelectorAll('#checkout-button-prompt, #checkout-button-prompt-full');
