/**
 * Checkout for Supply Chain AI article.
...
(function () {
  ...
  var CANCEL_URL = 'https://www.securebydezign.com/articles/supply-chain-ai.html';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var buttons = document.querySelectorAll('#checkout-button-supply_chain_ai, #checkout-button-supply_chain_ai-full');
