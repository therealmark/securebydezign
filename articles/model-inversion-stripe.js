/**
 * Checkout for Model Inversion article.
...
(function () {
  ...
  var CANCEL_URL = 'https://www.securebydezign.com/articles/model-inversion.html';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var buttons = document.querySelectorAll('#checkout-button-model_inversion, #checkout-button-model_inversion-full');
